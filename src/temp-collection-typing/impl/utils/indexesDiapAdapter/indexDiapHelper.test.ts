...
describe("indexDiapHelper", () => {
  it("standard", () => {
    ...
    expect(result._tag).toEqual(TG1TDisEnum.TG1T_DIS_BASE);
    if (result._tag === TG1TDisEnum.TG1T_DIS_BASE) {
  ...
  it("len 0", () => {
    ...
    expect(result._tag).toEqual(TG1TDisEnum.TG1T_DIS_EMPTY_ARR);
  });
  ...
  it("indexStart -2", () => {
    ...
    if (result._tag === TG1TDisEnum.TG1T_DIS_BASE) {
      ...
      expect(result.infos).toEqual(
        expect.arrayContaining([TG1TInfoEnum.TG1T_INF_INDEX_START_LESS_NIL])
      );
    }
  });
  ...
  it("indexEnd out of range", () => {
    ...
    if (result._tag === TG1TDisEnum.TG1T_DIS_BASE) {
      ...
      expect(result.infos).toHaveLength(1);
      expect(result.infos).toEqual(
        expect.arrayContaining([TG1TInfoEnum.TG1T_INF_INDEX_END_GREAT_LEN])
      );
    }
  });
  ...
  it("indexEnd < indexStart", () => {
    ...
    if (result._tag === TG1TDisEnum.TG1T_DIS_BASE) {
      ...
      expect(result.infos).toHaveLength(1);
      expect(result.infos).toEqual(
        expect.arrayContaining([TG1TInfoEnum.TG1T_INF_END_GREAT_START])
      );
    }
  });
  ...
  it("indexEnd === indexStart", () => {
    ...
    if (result._tag === TG1TDisEnum.TG1T_DIS_BASE) {
      ...
      expect(result.infos).toHaveLength(1);
      expect(result.infos).toEqual(
        expect.arrayContaining([TG1TInfoEnum.TG1T_INF_END_EQUAL_START])
      );
    }
  });
  ...
  it("indexStart > len", () => {
    ...
    if (result._tag === TG1TDisEnum.TG1T_DIS_BASE) {
      ...
      expect(result.infos).toHaveLength(1);
      expect(result.infos).toEqual(
        expect.arrayContaining([TG1TInfoEnum.TG1T_INF_INDEX_START_GREAT_OR_EQ_LEN])
      );
    }
  });
