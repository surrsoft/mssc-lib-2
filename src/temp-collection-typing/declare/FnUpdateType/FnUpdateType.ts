 ...
 *
 * Должен найти существующий элемент коллекции, с помощью {@link FnFindType}, и "обновить" его.
 *
 * Правила обновления:
 ...
 * 3) если поле в (1) is falsy, то нужно очистить поле элемента коллекции
 *
 ...
 * Если другая ошибка, то должен вернуть тип {@link TG6TErrorType}.
 *
 * @param elem (1)
 */
