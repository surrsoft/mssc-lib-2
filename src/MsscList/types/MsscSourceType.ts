...
export interface MsscSourceType<TModel> {
   ...
   *
   * Должен добавить элементы (1) в конец списка. Перед добавлением элемента, должен проверить нет ли уже существующего такого элемента, поиском по id; если уже есть - ниего не делать.
   *
